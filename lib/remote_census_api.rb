...
class RemoteCensusApi
  def call(document_type, document_number, date_of_birth, postal_code, attachment)
    response = nil
    get_document_number_variants(document_type, document_number).each do |variant|
      response = Response.new(get_response_body(document_type, variant, date_of_birth, postal_code, attachment))
  ...
  class Response
    ...
    def attachment
      path_value = Setting["remote_census.response.attachment"]
      extract_value(path_value)
    end
  ...
  private
    ...
    def get_response_body(document_type, document_number, date_of_birth, postal_code, attachment)
      if end_point_defined?
        request = request(document_type, document_number, date_of_birth, postal_code, attachment)
    ...
    def request(document_type, document_number, date_of_birth, postal_code, attachment)
      ...
      fill_in(structure, Setting["remote_cesus.request.attachment"], attachment)
